...
std::string ReplaceDelimitersWithCommas(const std::string& input, const std::string& delimiter)
{
...
std::string ExtractAndReplaceDelimiters(const std::string& input)
{
    ...
    numbersStr = ReplaceDelimitersWithCommas(numbersStr, delimiter);
    return numbersStr;
}
...
int StringCalculator::add(const std::string& input)
{
    ...
    std::string updatedInput = ExtractAndReplaceDelimiters(input);

    int sum = CalculateSum(updatedInput);
    CheckForNegativeNumbers(updatedInput);
